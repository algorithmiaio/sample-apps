...
(function() {
  window.safeGA = function(event) {
    if (typeof window.ga === 'function') {
      return window.ga(event);
    }
  };
  ...
  window.setCookieValue = function(name, value, opts) {
    var date, expireDays, extra;
    if (opts == null) {
      opts = {};
    }
    extra = '';
  ...
  if (getCookieValue("signup_session") === "true") {
    console.log("Thanks for signing up!");
    window.isFirstLogin = true;
    deleteCookie("signup_session", "/");
  }
  ...
  $(function() {
    ...
    if (location.hash === '#chatbox' && Intercom) {
